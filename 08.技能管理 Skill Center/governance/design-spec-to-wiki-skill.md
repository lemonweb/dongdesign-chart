...
```txt
用 design-spec-to-wiki-skill，把这个 Zero / Relay 图例设计规范完善到 01.视觉语言 Design Language/07.图例 Legend.md
```

```txt
用 design-spec-to-wiki-skill，把这个 Figma 折线图设计指南完善到 02.图表模式 Chart-type/04.基础图表 Basic/01.折线图 Line-chart.md
```
